...
#define TEST_PIN_REVERSE_COM {GPIOA, GPIO_PIN_10}
//#define TEST_PIN_REVERSE_COM {GPIOA, GPIO_PIN_11}
...
#define HW15_FRONT_LIGHT {GPIOC, GPIO_PIN_14}
#define HW15_CAB_LIGHT {GPIOC, GPIO_PIN_15}
#define HW15_REAR_LIGHT {GPIOH, GPIO_PIN_0}
