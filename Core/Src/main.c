...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
	...
	// TEST_PIN1 is enable at the beginning of the main.
	GPIO_CONFIG_OUTPUT(TEST_PIN1);
	GPIO_WRITE(TEST_PIN1, TRUE);

	Disable_Bootloader_If_Enabled();
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_2|GPIO_PIN_7|GPIO_Output___TIM1_CH1_Pin|GPIO_Output___TIM1_CH2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0|GPIO_PIN_1|GPIO_Output___LED_STAT_GREEN_Pin|GPIO_Output___LED_STAT_RED_Pin
                          |GPIO_Output___DCC_UPLINK_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PA2 PA7 GPIO_Output___TIM1_CH1_Pin GPIO_Output___TIM1_CH2_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_2|GPIO_PIN_7|GPIO_Output___TIM1_CH1_Pin|GPIO_Output___TIM1_CH2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : PB0 PB1 GPIO_Output___LED_STAT_GREEN_Pin GPIO_Output___LED_STAT_RED_Pin
                           GPIO_Output___DCC_UPLINK_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_1|GPIO_Output___LED_STAT_GREEN_Pin|GPIO_Output___LED_STAT_RED_Pin
                          |GPIO_Output___DCC_UPLINK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : GPIO_Input___DCC_RX_Pin */
  GPIO_InitStruct.Pin = GPIO_Input___DCC_RX_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIO_Input___DCC_RX_GPIO_Port, &GPIO_InitStruct);
...
void Disable_Bootloader_If_Enabled(void)
{
    ...
    // 0: nBOOT0 = 0
    // 1: nBOOT0 = 1 (Main Flash memory is selected as boot area)

    // Bit 26 nSWBOOT0: Software BOOT0
    // 0: BOOT0 taken from the option bit nBOOT0
    // 1: BOOT0 taken from PH3/BOOT0 pin
    if(((obConfig.USERConfig & OB_BOOT0_FROM_PIN) != OB_BOOT0_FROM_OB) ||
    		((obConfig.USERConfig & OB_BOOT0_SET) != OB_BOOT0_SET))
    {
    	obConfig.OptionType = OPTIONBYTE_USER;
      obConfig.USERType = OB_USER_nSWBOOT0 | OB_USER_nBOOT0;
      obConfig.USERConfig = OB_BOOT0_FROM_OB | OB_BOOT0_SET;
